...
- Structure Tree 通过 Mind Elixir 渲染，包含 85 个树节点、57 个可见文档，以及 10 个用于拆分 Workflow 的 topic group
- 中文 Structure Tree scope 包含 28 份文档和 45 个树节点，其中中文工作流包含 5 个 topic group
