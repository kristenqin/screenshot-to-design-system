...
- 移除中文语言视图中冗余的“中文”节点前缀。

原因：

- 用户已经处在中文语言选项下，“中文入口”“中文项目”等标签里的“中文”属于上下文信息，不应继续作为节点内容显示。

遵循步骤：

- 将中文 section 的显示标签改成上下文敏感：仅在中文语言视图中去掉“中文”前缀。
- 同步治理左侧导航分组标题和 Structure Tree section 节点。
- 将中文入口文档叶子从“中文文档入口”收敛为“文档入口”。
